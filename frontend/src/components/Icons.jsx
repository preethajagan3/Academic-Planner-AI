...
// Replace all emojis with proper SVG icons
...
export const RocketIcon = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path d="M2 13.17c0 .1.03.2.1.28l4.47 5.25c.17.2.45.28.7.2.25-.08.43-.3.43-.57v-2.06c0-.52.28-.99.73-1.2l2.35-1.1c.36-.16.59-.53.59-.92V9c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v2.33c0 .14-.06.27-.16.36L2.3 15c-.2.2-.3.46-.3.72v-2.55zm14-1.13V8.87c0-.39.23-.76.59-.92l2.35-1.1c.45-.21.73-.68.73-1.2V3.59c0-.27-.18-.49-.43-.57a.747.747 0 00-.7.2l-4.47 5.25c-.07.08-.1.18-.1.28v2.55c0 .26.1.52.3.72l3.54 3.31c.1.09.16.22.16.36V18c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-2.33c0-.39-.23-.76-.59-.92l-2.35-1.1c-.45-.21-.73-.68-.73-1.2V9.41c0-.14.06-.27.16-.36l3.54-3.31a1.001 1.001 0 011.69.7z" />
        <path d="M10 2a8 8 0 00-8 8c0 .7.09 1.38.25 2.03l4.46-4.19C6.9 7.32 7.42 7 8 7h4c.58 0 1.1.32 1.29.84l4.46 4.19c.16-.65.25-1.33.25-2.03a8 8 0 00-8-8z" />
    </svg>
);

export const SparklesIcon = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0V6H3a1 1 0 110-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM14 2a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0V6h-1a1 1 0 110-2h1V3a1 1 0 011-1z" clipRule="evenodd" />
    </svg>
);

export const TrophyIcon = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        <path d="M15 4h2a1 1 0 011 1v2a5 5 0 01-5 5H7a5 5 0 01-5-5V5a1 1 0 011-1h2V3a1 1 0 00-1-1H4a1 1 0 010-2h12a1 1 0 010 2h-1a1 1 0 00-1 1v1zM6 4h8v1H6V4z" />
    </svg>
);
...
export const LocationMarkerIcon = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
...
export const SparkleChatIcon = ({ className = "w-6 h-6" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.5 3.5l.3-.9.9-.3-.9-.3-.3-.9-.3.9-.9.3.9.3.3.9zM15 6l.2-.6.6-.2-.6-.2-.2-.6-.2.6-.6.2.6.2.2.6z" fill="currentColor" />
    </svg>
);
