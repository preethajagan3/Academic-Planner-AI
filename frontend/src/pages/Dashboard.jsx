        ...
        <div className="max-w-[100rem] mx-auto">
          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-start justify-between gap-10 transition-all duration-700 animate-fade-in">
            ...
            <div className="premium-card !p-8 border-none ring-1 ring-slate-100 shadow-2xl shadow-violet-100 flex items-center gap-8 max-w-lg">
              ...
              <div>
                <p className="text-xs font-black text-slate-500 uppercase tracking-widest mb-2">Neural Insight</p>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2 space-y-8">
              <div className="premium-card min-h-[500px] border-none shadow-2xl shadow-slate-200/40">
                ...
                {upcomingDeadlines.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-[350px] text-center">
                    <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mb-6 border border-slate-100 uppercase text-xs font-black text-slate-300">
                      <ClipboardIcon className="w-10 h-10" />
                    </div>
                    <p className="text-slate-400 font-black uppercase tracking-[0.2em] text-xs">No active sequences found</p>
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-white w-[88%] shadow-[0_0_15px_white]" />
                    </div>
                  </div>
                  <p className="text-sm font-medium text-white/80 leading-relaxed italic border-l-2 border-white/20 pl-4">
                    "Highest productivity recorded in Science tracks this week."
                  </p>
                </div>
              </div>
